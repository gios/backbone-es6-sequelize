...
var _templatesContact_list_itemTpl = require("./templates/contact_list_item.tpl");

var _templatesContact_list_itemTpl2 = _interopRequireDefault(_templatesContact_list_itemTpl);
...
(0, _jquery2["default"])(document).ready(function () {
  ...
  ContactManager.ContactItemView = _backboneMarionette2["default"].ItemView.extend({
    tagName: "li",
    template: _lodash2["default"].template(_templatesContact_list_itemTpl2["default"])
  });

  ContactManager.ContactsView = _backboneMarionette2["default"].CollectionView.extend({
    tagName: "ul",
...
},{"./templates/contact_list_item.tpl":2,"backbone":7,"backbone.marionette":3,"jquery":9,"lodash":10}],2:[function(require,module,exports){
module.exports = "<p><%- firstName %>&nbsp<%- lastName %></p>";
